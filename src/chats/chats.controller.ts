...
export class ChatsController {
	...
	@ApiResponse({ status: 400.4, description: ApiResponseError.PasswordTooLong })
	@ApiResponse({ status: 400.5, description: ApiResponseError.AlreadyInChannel })
	@ApiResponse({ status: 400.6, description: ApiResponseError.ChannelNotFound })
	@ApiResponse({ status: 400.7, description: ApiResponseError.DirectYourseft })
	@ApiResponse({ status: 400.8, description: ApiResponseError.RemoteUserNotFound })
	@ApiResponse({ status: 400.9, description: ApiResponseError.AlreadyDirect })
	@ApiResponse({ status: 404, description: ApiResponseError.ChannelNotFound })
	@HttpCode(200)
	@Post()
	async join(
