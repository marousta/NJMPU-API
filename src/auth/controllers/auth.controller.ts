...
export class AuthController {
	...
	@ApiResponse({ status: 400.08, description: ApiResponseError.PasswordWrongFormatCase })
	@ApiResponse({ status: 400.09, description: ApiResponseError.PasswordWrongFormatNumeric })
	@ApiResponse({ status: 400.1, description: ApiResponseError.PasswordWrongFormatSpecial })
	@ApiResponse({ status: 400.11, description: ApiResponseErrorUser.EmailTaken })
	@HttpCode(201)
	@Post('signup')
